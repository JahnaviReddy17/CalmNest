...
Context:
This chatbot is part of a project called "Calm Nest", focused on helping users with productivity, mental well-being, and guidance.
  ...
  try {
    ...
    if (
      ...
      crisis = await CrisisAlert.create({
        userId,
        severity: sentiment.severity || (sentiment.crisis ? "critical" : "medium"),
        triggerSource: "chat",
